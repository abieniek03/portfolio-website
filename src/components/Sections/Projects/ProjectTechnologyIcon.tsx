...
const ProjectTechnologyIcon: FC<{ technology: string }> = ({ technology }) => {
	const styles: string = 'flex justify-center items-center h-7 px-2 py-0.5 text-white text-sm border-2';
	return (
		<div
			className={`${styles} ${technology === 'Vue' && 'bg-emerald-400 border-emerald-500'}
